...
- O crédito não entra em `totals.income` e o gasto não entra em `totals.expense`, então a sobra do mês não infla com benefício que só dá para gastar em comida. `walletSummary(vale, ciclo)` devolve o **limite total** (o que sobrou do ciclo anterior mais o crédito que **já caiu**) e o **restante**. Crédito com data à frente entra em `pending`, não no saldo: enquanto o dia não chega o dinheiro não está no cartão, e mostrá-lo como disponível seria mentira. Em ciclo futuro tudo conta, porque aí a tela inteira é previsão.O não usado passa para o mês seguinte, como no cartão de verdade.
- O **gráfico de categorias** deixa o gasto de vale de fora por padrão, para fechar com o total de despesas do mês — ele não saiu do caixa. O chip **"Incluir vales"** traz de volta, e aí a rosca mostra o consumo inteiro em vez de só o dinheiro. O chip só aparece para quem tem vale cadastrado.
